import style from "./SearchSupplier.module.css";
...
export default function SearchSupplier() {
    ...
    return (
        <>
            ...
            <div class="modal fade " tabindex="-1" id="edit-category-modal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class={cn("modal-content", "modal-inner-content")}>
                        <div class="modal-header">
                            <h3 className={cn("modal-title")}>Danh mục</h3>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class={cn("modal-body", "attribute-form")}>
