...
export default function Order() {
    ...
    const handleCreateOrder = () => {
        ...
        var orderDetail = []
        productPurchaseList.forEach(element => {
            var temp = {
                quantity: element.quantity,
                unitPrice: element.variant.sellingPrice,
                    ...
                    <div className={cn("row g-3 align-items-center")}>
                        ...
                        <div className={cn("col-sm-8 col-lg-10 mt-0")}>
                            <input
                                ...
                                type="text" id="inputNote" className={cn("form-control", "input-note")}
                                aria-describedby="" />
                        </div>
                    </div>
                </section>
                    ...
                    <div className={cn("content")}>
                        ...
                        <div className={cn("text-center")}>
                            <button
                                ...
                                type="button" id="" className={cn("btn-3", "pay-btn")}>
                                Xác nhận thanh toán
                            </button>
                        </div>
                    </div>
